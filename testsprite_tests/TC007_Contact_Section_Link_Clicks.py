...
async def run_test():
    ...
    try:
        ...
        # -> Click the Reload button (index 201) to retry loading the site and then, if the site loads, navigate to the Contact section to test the email and social cards.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=html/body/div[1]/div[1]/div[2]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
